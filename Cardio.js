...
const together = inventors.reduce((total, inventor) => {
...
//     .filter(streetName => MediaStreamAudioDestinationNode.includes('de'));
    // 7. sort Exercise
    // Sort the people alphabetically by last name
const sorting = people.sort((lastOne, nextOne) => {
